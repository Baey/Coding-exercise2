...
typedef ac_int<S_W, true> s_int_t;
typedef ac_fixed< S_W,  S_I, true, trn, AC_WRAP> s_rnd_t; // s = t0 + t1 + t2
...
typedef ac_int<SQ_W, false> sq_int_t;
...
typedef ac_int<T0_W,  true> t0_int_t;
...
typedef ac_int<T1_W,  true> t1_int_t;
...
typedef ac_int<T2_W,  true> t2_int_t;
